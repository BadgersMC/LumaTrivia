...
- [x] **INFRA-04** — Create loader class  
  Ref: REQ-017  
  Tag: INFRA  
  `LumaTriviaLoader.kt` extending `NexusPaperPluginLoader`.  
  Evidence: ` `
